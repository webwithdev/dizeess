        ...
        <div className="grid lg:grid-cols-2 relative z-10">
          ...
          <div className="p-4 sm:p-6 lg:p-12 bg-gradient-to-b from-white via-gray-50 to-white overflow-y-auto custom-scrollbar">
            <div className="w-full max-w-2xl mx-auto space-y-6 sm:space-y-8 pb-12 sm:pb-16">
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 lg:p-8 shadow-lg border-2 border-gray-100">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-3 bg-white rounded-xl p-3 border border-gray-100 shadow-sm">
                      <span className="w-7 h-7 bg-gradient-to-br from-[#065f46] to-[#064e3b] rounded-full flex items-center justify-center text-white text-sm font-bold">✓</span>
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 lg:p-8 shadow-lg border-2 border-gray-100">
                <h3 className="text-2xl font-black text-gray-900 mb-4">Hey, I'm Devansh</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 lg:p-8 shadow-lg border-2 border-gray-100">
                <h3 className="text-2xl font-black text-gray-900 mb-4">What You Get</h3>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3">
                      <span className="flex-shrink-0 w-7 h-7 bg-gradient-to-br from-[#065f46] to-[#064e3b] rounded-full flex items-center justify-center text-white text-sm font-bold">✓</span>
                      <span className="text-gray-700 font-medium leading-relaxed">{item}</span>
                    </li>
                  ))}
                </ul>
                <p className="text-gray-700 leading-relaxed mt-4">This is not content. This is a reset protocol.</p>
              </div>

              <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 lg:p-8 shadow-lg border-2 border-gray-100">
                <h3 className="text-2xl font-black text-gray-900 mb-4">Who It Is For</h3>
                <ul className="space-y-3">
                  {[
